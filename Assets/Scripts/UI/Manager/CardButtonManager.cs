...
namespace CardGame.UISystem.Controller
{
    ...
    public class CardButtonManager
    {
        ...
        private void UpdateCardDisplays()
        {
            ...
            {
                // 要素がnull、または破棄済みならスキップ
                if (cardDisplay == null)
                {
                    continue;
                }

                // GameObjectが非アクティブならUI更新を行わない
